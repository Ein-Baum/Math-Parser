...
/**
 * Divides the second value from the first value.
 * @author MiKa
 * @version 1.0 (28.02.2023)
 * @since ALPHA
 */
public class DivExpression implements FunctionalExpression {

	private Expression first, sec;
	
	public DivExpression(Expression first, Expression sec) {
		this.first = first;
		this.sec = sec;
	}
